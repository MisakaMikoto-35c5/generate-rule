...
class ProxyRuleUpdater:
    ...
    USER_AGENT = 'ProxyRuleUpdater/0.1'
    FILE_HEADER_FORMAT = '# Generated by ProxyRuleUpdater/0.1\n\n'
    ...
    def gen_rule(self, config_path):
        ...
        for rules_url in rules_list:
            ...
            if rules_type == 'hosts':
                ...
                self.save_file(file_prefix + '-hostnames.conf', hostnames, file_header) # 保存文件
                ...
                self.save_file(file_prefix + '-hostnames.conf', hostnames, file_header)
                self.save_file(file_prefix + '-rejection.conf', regex_rejection, file_header)
